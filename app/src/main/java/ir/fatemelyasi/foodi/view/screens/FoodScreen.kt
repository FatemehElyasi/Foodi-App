...
import ir.fatemelyasi.foodi.view.screens.Food
import ir.fatemelyasi.foodi.view.screens.FoodList
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                ...
                title = {
                    Text(text = "Food", fontFamily = ubuntuFontFamily)
                }
            )
        }
    ) { paddings->
        Column(modifier = Modifier
            ...
            Image(
                modifier= Modifier
                    .fillMaxWidth()
                    .heightIn(max = 200.dp),
                painter = painterResource(id = FoodList.random().image),
                contentDescription = null,
                contentScale = ContentScale.Crop
            )
            Spacer(modifier = Modifier.height(16.dp))
            Column(modifier=Modifier.padding(horizontal = 16.dp)) {
                Text(text = FoodList.random().name, fontSize = 18.sp, fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.height(16.dp))
